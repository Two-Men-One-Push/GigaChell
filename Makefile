...
#    Updated: 2025/08/23 18:27:38 by ethebaul         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LDLIBS				=	-L/home/ethebaul/local/lib -Wl,-rpath,/home/ethebaul/local/lib -lreadline -lncurses -L$(LIBFT_DIR) -l$(patsubst lib%,%,$(notdir $(basename $(LIBFT_ARCHIVE))))
