...
TERMINFO="/home/ethebaul/local/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/ethebaul/Documents/Github/GigaChell/.ncurses-6.3/man_alias.sed" ; then
cat >>/home/ethebaul/Documents/Github/GigaChell/.ncurses-6.3/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/ethebaul/Documents/Github/GigaChell/.ncurses-6.3/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/ethebaul/Documents/Github/GigaChell/.ncurses-6.3/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/ethebaul/Documents/Github/GigaChell/.ncurses-6.3/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/ethebaul/Documents/Github/GigaChell/.ncurses-6.3/man_alias.sed" \
		< "$i" | sed -f /home/ethebaul/Documents/Github/GigaChell/.ncurses-6.3/edit_man.sed >$TMP
