...
/*   Updated: 2025/08/23 15:31:54 by ethebaul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_tinfo_internal(void)
{
	...
	const t_term			*cur_term = *(t_term **)(base + 0x46da8);
...
void	free_readline_internal(void)
{
	...
	free(*(void **)(base + 0x5f8a8));
	free(*(void **)(base + 0x5f8e0));
	free(*(void **)(base + 0x5f730));
	free(*(void **)(base + 0x5f748));
	free(*(void **)(base + 0x60820));
	free(*(void **)(base + 0x60800));
}
